...
export ROOK_EXAMPLES_DIR="${ROOK_EXAMPLES_DIR:="$SCRIPT_ROOT"/manifests/ceph-service}" ## Path to Rook examples directory (i.e github.com/rook/rook/deploy/examples)
